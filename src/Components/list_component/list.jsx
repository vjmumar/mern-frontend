...
return <button onClick = {handleLikes.bind(this, post , details)} className = "list_postLike">{text} {likeArray.length}</button> 
}

const deletePostButton = (post) => {
if (post.belongsTo === myId){
return <button onClick = {handleRemovePost.bind(this, post._id)} className = "list_removePost">Delete</button> 
}
}
...
<p onClick = {showCommentOnSpecificPost.bind(this, post)} className = "list_commentLabel">Comments</p>
